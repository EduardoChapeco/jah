...
export function AIHunterPanel({
  ...
  const leadId = propLeadId || lead?.id || "";
  const agencyId = propAgencyId || lead?.agency_id || lead?.store_id || "";
      ...
      <div className="rounded-[var(--radius-card)] border border-brand/20 bg-brand/[0.02] p-5 space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 text-brand ds-label-caps">
            <Zap className="h-4 w-4" /> Sugestão de Proposta
          </div>
          {createdProposal && (
        ...
        <div className="flex flex-wrap gap-2 pt-1">
          ...
          >
            <Zap className={`h-3.5 w-3.5 ${generatingProposal ? "animate-spin" : ""}`} />
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              >
                <div className={`flex items-center gap-2 ${color} ds-label-caps`}>
                  {icon} {title}
                </div>
          ...
          {insights.next_best_action && (
            <div className="rounded-[var(--radius-card)] border border-success/30 bg-success/5 p-5 space-y-2">
              <div className="flex items-center gap-2 text-success ds-label-caps">
                <Zap className="h-4 w-4" /> Próxima Melhor Ação (NBA)
              </div>
