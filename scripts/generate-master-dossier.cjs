...
const targetPath = path.resolve(__dirname, '../docs/MASTER_INTENSIFICACAO_500_PROMPTS_CONSELHO_EXECUTIVO.md');

const docContent = `# MASTER_INTENSIFICACAO_500_PROMPTS_CONSELHO_EXECUTIVO.md
...
console.log('Successfully generated MASTER_INTENSIFICACAO_500_PROMPTS_CONSELHO_EXECUTIVO.md');
