...
const sqlPath = path.resolve(__dirname, "../supabase/migrations/20260904140000_hotels_bank_enterprise_expansion.sql");
...
async function run() {
  ...
  for (const cfg of configs) {
    ...
    try {
      ...
      await sql`SELECT 1`;
      console.log("Query OK! Aplicando migration Hotels Bank Expansion...");
      await sql.unsafe(sqlContent);
      console.log("✓ Migration 20260904140000 APLICADA COM SUCESSO!");
