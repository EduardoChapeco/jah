-- ============================================================================
-- Waesy Commerce — Seed Data (Template Loja de Calçados)
-- ============================================================================
...
-- Depende da Migration 0022 que cria a store 'waesy'.
...
DECLARE
  ...
  v_prod_2 UUID;
BEGIN
  -- Obter a store padrão (Waesy)
  SELECT id INTO v_store_id FROM public.stores WHERE slug = 'waesy' LIMIT 1;

  IF v_store_id IS NULL THEN
    RAISE EXCEPTION 'Store waesy não encontrada. Execute as migrations primeiro.';
  END IF;
