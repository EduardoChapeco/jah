-- Atualiza a procedure de criação atômica de produtos para suportar venda sob encomenda (backorder)
  ...
  IF jsonb_typeof(payload->'variants') = 'array' AND jsonb_array_length(payload->'variants') > 0 THEN
    ...
    LOOP
      ...
      VALUES (
        ...
        COALESCE((v_variant->>'backorder_lead_time_days')::integer, 0),
        COALESCE((v_variant->>'requires_payment_for_backorder')::boolean, true),
        v_now,
        v_now
