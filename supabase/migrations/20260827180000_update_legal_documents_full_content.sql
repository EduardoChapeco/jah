...
## 2. REGRAS DE CADASTRO, CONTA E COMPLIANCE RIGOROSO

**2.1. Veracidade e Unicidade.** O usuário é o único responsável pela veracidade, exatidão e atualização dos dados cadastrais (CPF, CNPJ, e-mail, telefone, endereço). O uso de dados falsos, documentos de terceiros ou identidades simuladas constitui crime de falsidade ideológica (Art. 299 do Código Penal) e estelionato, ensejando expulsão imediata e denúncia às autoridades.

**2.2. Guarda de Credenciais.** A conta é pessoal, intransferível e protegida por senha/token. Qualquer ação praticada a partir da conta logada será imputada integralmente ao seu titular cadastrado.
...
## 3. CONTEÚDO GERADO POR USUÁRIOS (UGC) E MARCO CIVIL DA INTERNET
...
- Verificação de identidade e prova de vida biométrica.

**7.2. Dados Biométricos (Reconhecimento Facial e Voiceprint).** O usuário expressamente consente com a coleta e tratamento de dados biométricos (características faciais e impressão vocal) para autenticação segura, prevenção de golpes e combate a perfis falsos.

**7.3. Prazo de Retenção de Mídias para IA.** Os registros de áudio, vídeo e imagem captados poderão ser mantidos para fins de treinamento e segurança por **até 24 (vinte e quatro) meses** a partir da data de coleta, sem prejuízo da manutenção de dados desidentificados/anonimizados por prazo indeterminado.

---

## 8. TRATAMENTO, COMPARTILHAMENTO E MONETIZAÇÃO DE DADOS (LGPD)
...
Estes Termos são integralmente regidos pelas leis da República Federativa do Brasil. Para dirimir quaisquer litígios decorrentes deste instrumento, as partes elegem:
- Para relações de consumo tuteladas pelo CDC: o foro do domicílio do consumidor (Art. 101, I da Lei nº 8.078/1990);
- Para relações comerciais entre lojistas/anunciantes e a Plataforma: o foro da comarca da sede administrativa da Plataforma, com renúncia a qualquer outro.
...
UPDATE public.legal_documents SET
  ...
  content_markdown = $sql_doc$# Política de Privacidade e Proteção de Dados (LGPD)
...
- **Identidade:** Nome completo, data de nascimento, CPF/CNPJ, RG, foto de perfil
- **Contato:** E-mail, número de telefone/WhatsApp, endereço completo com CEP
- **Dados Financeiros:** Dados de cartão de crédito/débito (tokenizados pelo gateway), conta bancária/PIX para repasses
- **Documentos KYC:** CNH, comprovante de endereço, alvarás comerciais e outros documentos de verificação

### 2.2 Dados Coletados Automaticamente
- **Técnicos:** Endereço IP, User-Agent, tipo e versão de navegador, sistema operacional, identificadores de dispositivo (IDFA/GAID), device fingerprint
- **Comportamentais:** Páginas visitadas, tempo de sessão, cliques, rolagem, buscas realizadas, carrinho de compras, histórico de pedidos e favoritos
- **Geolocalização:** Coordenadas GPS (quando autorizado), localização aproximada por IP, histórico de localizações para rastreamento de entregas
- **Metadados de Mídia:** EXIF de imagens enviadas (local, data, câmera), metadados de vídeos e áudios

### 2.3 Dados Biométricos e Sensoriais
- **Reconhecimento facial:** Capturado para verificação de identidade (prova de vida), controle de acesso e prevenção de fraudes
- **Impressão de voz (voiceprint):** Extraída de gravações de áudio enviadas ou geradas na Plataforma
- **Padrões comportamentais:** Análise de padrões de digitação, movimentos de mouse/toque, ritmo de interação para detecção de bots e segurança
...
| Verificação de identidade e segurança | Legítimo interesse / Obrigação legal (Art. 7º, VI e IX) |
| Prevenção de fraudes e lavagem de dinheiro | Cumprimento de obrigação legal (Art. 7º, VI) |
| Treinamento de modelos de Inteligência Artificial | Consentimento expresso (Art. 7º, I) |
| Marketing personalizado e publicidade segmentada | Consentimento expresso (Art. 7º, I) |
| Compartilhamento/comercialização de dados com parceiros | Consentimento expresso (Art. 7º, I) |
| Pesquisa e análise de mercado | Legítimo interesse (Art. 7º, IX) |
| Cumprimento de obrigações legais e regulatórias | Cumprimento de obrigação legal (Art. 7º, VI) |
| Cooperação com autoridades em investigações criminais | Cumprimento de obrigação legal (Art. 7º, VI) |
...
|---|---|
| Dados cadastrais (conta ativa) | Enquanto ativa + 5 anos |
| Logs forenses de aceite de termos | 10 anos (obrigação legal) |
| Registros de transações financeiras | 10 anos (obrigação fiscal) |
| Logs de segurança e acesso | 2 anos (Marco Civil da Internet, Art. 15) |
| Dados biométricos (reconhecimento facial) | 5 anos ou até revogação do consentimento |
| Áudio, vídeo e imagem para IA | **Até 24 meses**, prorrogável por obrigação legal |
| Dados de geolocalização | 6 meses (entregas) / 2 anos (análise comportamental) |
...
**5.5. Transferência Internacional:** Os dados podem ser transferidos para servidores nos EUA (AWS, Google Cloud, Cloudflare), na União Europeia e em outros países com nível adequado de proteção, conforme Art. 33 da LGPD.
...
- ✅ **Acessar** seus dados pessoais coletados pela Plataforma
- ✅ **Corrigir** dados incompletos, inexatos ou desatualizados
- ✅ **Solicitar anonimização, bloqueio ou eliminação** de dados desnecessários
- ✅ **Portabilidade** dos seus dados para outro prestador de serviço
...
Adotamos medidas técnicas e administrativas de segurança adequadas para proteger seus dados, incluindo:
...
Em caso de incidente de segurança que afete dados pessoais, notificaremos os titulares afetados e a ANPD nos prazos legais.
...
UPDATE public.legal_documents SET
  ...
  content_markdown = $sql_doc$# Política de Cookies e Gestão de Consentimento Digital
...
- **Cookies:** Arquivos de texto armazenados no seu navegador ou dispositivo que nos permitem reconhecer sua sessão, personalizar sua experiência e analisar o uso da Plataforma.
- **Pixels de rastreamento:** Pequenas imagens invisíveis que registram sua interação com páginas e e-mails.
- **Local Storage / Session Storage:** Armazenamento local no navegador para preferências e sessões.
- **Device Fingerprinting:** Identificação única do dispositivo baseada em características técnicas (versão de OS, resolução, fontes instaladas, plugins, etc.).
- **Identificadores de Publicidade:** IDFA (iOS) e GAID (Android) para publicidade segmentada em dispositivos móveis.

---

## 2. CATEGORIAS DE COOKIES

### Estritamente Necessários (Não requerem consentimento)
Indispensáveis para o funcionamento da Plataforma:
- Autenticação e manutenção de sessão segura
- Identificação do espaço de trabalho (tenant ativo) em ambiente multi-tenant
- Token CSRF para proteção contra ataques cross-site
- Carrinho de compras e preferências de checkout
- **Registro forense do aceite de termos** — armazenamento do comprovante de consentimento com valor probatório

### Funcionalidade (Requerem consentimento)
- Modo escuro/claro e preferências de interface
- Idioma e região preferida
- Loja e categorias favoritas
- Localização aproximada para cálculo de frete e exibição de anúncios locais

### Analíticos e de Desempenho (Requerem consentimento)
- Análise de tráfego e comportamento de navegação (Google Analytics, Plausible ou similar)
- Mapas de calor e gravação de sessões para otimização de UX
- Testes A/B e experimentos de interface

### Publicidade e Rastreamento (Requerem consentimento)
- **Publicidade segmentada** baseada em interesses, comportamento e localização
- Pixels de conversão de parceiros de publicidade (Meta, Google Ads, TikTok Ads)
- Rastreamento cross-device para reconhecimento entre dispositivos do mesmo usuário
- **Compartilhamento com redes de publicidade** para monetização da Plataforma

---

## 3. VALOR PROBATÓRIO DO ACEITE

O registro do seu aceite desta Política e dos demais Termos é armazenado de forma **forense e imutável**, contendo:

| Dado Registrado | Finalidade |
|---|---|
| IP de origem (IPv4/IPv6) | Identificação geográfica e probatória |
| Hash SHA-256 do IP | Comprovação íntegra e anônima |
| User-Agent completo | Identificação do navegador/dispositivo |
| Timestamp UTC | Data e hora exata do aceite |
| Versão dos Termos aceitos | Garantia de qual versão foi aceita |
| ID de sessão | Vinculação à sessão ativa |
| ID do usuário (se logado) | Vínculo permanente à conta |
| Hash de assinatura digital | Integridade e não-repúdio do aceite |

Esses registros constituem prova válida de consentimento perante o ordenamento jurídico brasileiro e podem ser utilizados em procedimentos administrativos, arbitrais ou judiciais.

---

## 4. GERENCIAMENTO DE COOKIES

**Via Plataforma:** Acesse **Minha Conta > Privacidade & Cookies** para gerenciar suas preferências a qualquer momento.

**Via Navegador:** Você pode bloquear ou limpar cookies nas configurações do seu navegador. Note que isso pode prejudicar o funcionamento de funcionalidades essenciais.

**Limitações:** Os cookies estritamente necessários não podem ser desativados sem comprometer o acesso seguro à Plataforma. A revogação do consentimento para cookies analíticos e de publicidade não elimina os dados já coletados, que permanecem sujeitos aos prazos de retenção descritos na Política de Privacidade.
...
UPDATE public.legal_documents SET
  ...
  content_markdown = $sql_doc$# Termo de Isenção da Plataforma e Diretrizes Setoriais de Negociações
...
**8.3. Impulsionamento a Lojistas em Dificuldade.** O lojista em dificuldades financeiras pode relatar sua situação no painel para receber descontos e **impulsionamento algorítmico de vendas no backend**.

---

## 9. ISENÇÃO POR INDISPONIBILIDADE TÉCNICA E LUCROS CESSANTES
...
## 10. DIRETRIZES DE SEGURANÇA CONTRA GOLPES (CHECKLIST DO USUÁRIO)

- 🚫 **NUNCA faça pagamentos antecipados** de sinal ou frete para vendedores desconhecidos em classificados;
- 👁️ **Exija ver o produto ou veículo pessoalmente** antes de realizar qualquer transferência bancária;
- 🏢 **Marque encontros em locais públicos, iluminados e movimentados**;
- 🩺 **Em procedimentos de saúde/estética**, verifique sempre o registro profissional ativo no CRM/CRO/COREN;
- ✈️ **Em pacotes de viagem**, solicite o número do CADASTUR da agência e confirme as reservas diretamente com os hotéis e companhias de transporte;
- 🚨 **Denuncie anúncios suspeitos** imediatamente aos administradores da Plataforma.
...
UPDATE public.legal_documents SET
  ...
  content_markdown = $sql_doc$# Termos de Adesão e Responsabilidades de Lojistas, Empresas, Agências e Prestadores
...
## 3. REQUISITOS CADASTRAIS E REGULARIDADE FISCAL (KYC / KYB)

**3.1. Documentação Obrigatória:**
- Pessoa Jurídica: CNPJ ativo perante a Receita Federal (MEI, ME, EPP, LTDA);
- Pessoa Física / Autônomo / Produtor Rural: CPF regular e comprovante de endereço.

---

## 4. LICENÇAS SETORIAIS OBRIGATÓRIAS

O Anunciante declara possuir todas as licenças aplicáveis ao seu ramo:
- **Alimentação / Restaurantes:** Alvará Sanitário da Vigilância Sanitária e registros na ANVISA;
- **Turismo / Hotéis / Passeios:** Registro ativo no **CADASTUR** (Ministério do Turismo);
- **Saúde / Estética / Cuidados Pessoais:** Habilitação profissional no respectivo Conselho de Classe (CRM, CRO, CRF, COREN, CRBM);
- **Eletrônicos e Brinquedos:** Selos de certificação INMETRO / ANATEL.

---

## 5. PRODUTOS E SERVIÇOS EXPRESSAMENTE PROIBIDOS

É vedada a comercialização de produtos falsificados/réplicas, armas/munições, entorpecentes, cigarros eletrônicos (vapes), medicamentos controlados sem receita, animais silvestres e serviços ilegais. O descumprimento ensejará **banimento sumário e comunicação imediata às autoridades policiais (Polícia Civil e Federal)**.

---

## 6. RESPONSABILIDADES COMERCIAIS PERANTE O CONSUMIDOR (CDC)

O Anunciante é o único e exclusivo fornecedor perante o consumidor final (Art. 18 e 49 do CDC), respondendo por garantia, vícios, prazos de entrega, emissão de Nota Fiscal e eventuais pedidos de troca ou devolução.
...
VALUES (
  ...
  $sql_doc$# Termos e Condições para Entregadores, Motoboys e Parceiros de Logística
...
- Aceitar, negociar ou recusar livremente qualquer solicitação de frete ou entrega;
- Definir suas próprias rotas, pausas para descanso e métodos de locomoção;
- Prestar serviços concomitantemente a outras plataformas digitais (como iFood, Uber, 99, Rappi, Lalamove, Borzo) ou a clientes particulares fora da Plataforma, inexistindo qualquer dever de exclusividade.

**1.3. Instrumentos de Trabalho Próprios.** O veículo (motocicleta, bicicleta, automóvel, van), combustível, equipamentos de proteção individual (capacete, colete refletivo, luvas), bag/mochila térmica, smartphone e plano de dados são de propriedade, responsabilidade e custeio exclusivo do Parceiro Entregador.

---

## 2. REQUISITOS CADASTRAIS, REGULARIDADE E DADOS BIOMÉTRICOS
...
- Para condutores de veículos automotores: CNH válida com a observação de exercício de atividade remunerada (**EAR**);
...
- O Parceiro Entregador consente com o compartilhamento de sua **geolocalização em tempo real** com o contratante e com o destinatário durante a execução ativa de um frete.

---

## 3. SISTEMA DE TARIFAS DINÂMICAS E PAGAMENTOS

**3.1. Estimativa Algorítmica Sugestiva.** As tarifas de frete exibidas na Plataforma são calculadas por algoritmos baseados em estimativa de distância, tempo previsto de trajeto e densidade de demanda no momento da solicitação. Essas tarifas constituem **mera sugestão de valor de referência**.

**3.2. Liberdade de Negociação Direta.** O Parceiro Entregador e o contratante têm plena liberdade para acordar valores diferenciados caso haja condições especiais de transporte (carga pesada, múltiplos volumes, espera prolongada, chuva intensa, etc.).

**3.3. Liquidação e Repasses.** Os valores processados digitalmente serão repassados ao Parceiro Entregador via Pix ou conta bancária cadastrada, descontadas as taxas administrativas da Plataforma e tarifas de processamento financeiro.

---

## 4. RESPONSABILIDADES CIVIS, CRIMINAIS E DE TRÂNSITO
...
## 5. REGRAS DE CONDUTA, HIGIENE E HIGIENIZAÇÃO DE BAGS

**5.1. Normas Sanitárias:**
- As caixas ou mochilas térmicas (bags) destinadas ao transporte de alimentos devem ser mantidas rigorosamente limpas, higienizadas e livres de odores ou substâncias contaminantes (conforme orientações da ANVISA e Vigilância Sanitária);
- É expressamente proibido transportar substâncias químicas, produtos de limpeza, ferramentas ou animais junto com alimentos prontos para consumo.

**5.2. Conduta Ética e Respeito:**
- Manter postura profissional, cortês e respeitosa com clientes, comerciantes e público em geral;
- É proibido assediar, intimidar, discriminar, ofender ou manter contato inadequado com clientes fora do âmbito estrito da entrega;
- É terminantemente proibido transportar mercadorias ilícitas, drogas, armas ou pacotes sem identificação de procedência. A suspeita de transporte de materiais ilegais resultará em denúncia imediata à Polícia Militar/Civil.

---

## 6. AVALIAÇÕES DA COMUNIDADE E DESCREDENCIAMENTO

**6.1. Sistema de Reputação Comunitária.** Os contratantes e destinatários poderão avaliar o serviço do Parceiro Entregador após cada corrida. Avaliações e comentários são públicos para fomentar a confiança na comunidade local.

**6.2. Hipóteses de Descredenciamento:**
- Prática comprovada de fraudes, simulação de corridas ou retenção indevida de mercadorias;
- CNH suspensa, cassada ou vencida;
- Reclamações reiteradas de comportamento agressivo ou desrespeito a normas sanitárias;
- Envolvimento em ilícitos penais ou denúncias de segurança pública.

---

*Ao aceitar este Contrato e ativar seu modo de entregador, você declara estar apto, habilitado e ciente de todas as condições de autonomia e responsabilidade aqui previstas.*
$sql_doc$
)
...
VALUES (
  ...
  $sql_doc$# Aviso sobre Uso de Inteligência Artificial e Dados Biométricos
...
|---|---|---|
| Reconhecimento facial | Fotos de perfil, selfies de verificação | Verificação de identidade, prevenção de fraudes |
| Análise de voz (voiceprint) | Gravações de áudio enviadas | Autenticação biométrica, detecção de bots |
| Análise comportamental | Padrões de navegação, cliques, compras | Personalização, recomendação de produtos |
| Moderação de conteúdo | Imagens, textos, vídeos publicados | Detecção de conteúdo ilegal ou inapropriado |
| Análise de fraude | Dados de transação, IP, geolocalização | Prevenção de chargebacks e golpes |
| Busca semântica | Histórico de buscas, comportamento | Melhoria dos resultados de busca |
| Recomendação visual | Imagens de produtos publicados | Recomendações personalizadas de compra |

---

## 2. DADOS BIOMÉTRICOS COLETADOS

Dados biométricos são categorias especiais de dados pessoais que exigem consentimento explícito conforme o Art. 11 da LGPD. Ao usar recursos que os envolvam, você **consente expressamente** com:

**Reconhecimento Facial:** Análise das características faciais para verificação de identidade e "prova de vida" (liveness detection). Os dados faciais são convertidos em representações matemáticas (embeddings) e armazenados de forma criptografada.

**Análise de Voz:** Extração de impressão vocal (voiceprint) de gravações de áudio para autenticação e detecção de conteúdo gerado por IA (deep fakes de voz).

**Análise Comportamental Biométrica:** Padrões de digitação (velocidade, ritmo), movimentos de toque na tela e comportamento de navegação para detecção de bots e autenticação contínua de segurança.

---

## 3. RETENÇÃO DE DADOS PARA TREINAMENTO DE IA

| Tipo de Dado | Prazo de Retenção |
|---|---|
| Dados biométricos ativos (facial/voz) | 5 anos ou até revogação do consentimento |
| Conteúdo de mídia (fotos, vídeos de produtos) | 24 meses após a exclusão da Plataforma |
| Gravações de suporte e verificação | 12 meses |
| Dados de treinamento anonimizados | Indefinidamente (sem possibilidade de reidentificação) |

Após os prazos acima, os dados são anonimizados e podem ser utilizados indefinidamente para melhoria dos modelos de IA, sem possibilidade de reidentificação do titular.
...
- Parceiros de verificação de identidade e KYC certificados

Todos os parceiros estão sujeitos a acordos de processamento de dados (DPA) compatíveis com a LGPD e com as legislações aplicáveis nos países onde operam.
...
- Moderação automatizada de conteúdo publicado
