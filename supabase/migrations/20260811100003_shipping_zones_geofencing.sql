-- ============================================================================
-- Waesy Commerce — Migration V4: Delivery V4 (Agnostic Logistics)
-- ============================================================================
...
-- For now, Waesy standard uses pure Postgres or application-layer math, so we just add standard indexes on store_id and type.
