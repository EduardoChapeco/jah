-- ============================================================================
-- Waesy PLATFORM — LEGAL COMPLIANCE, LGPD & IMMUTABLE CONSENT LOGS SCHEMA
-- ============================================================================
...
(
  'termos',
  'Termos Gerais de Uso e Condições da Plataforma Waesy',
  'platform_terms',
  '2.0',
  true,
  true,
  'Regras gerais de utilização, responsabilidades de contas, comércio eletrônico, intermediação e convivência na plataforma Waesy.',
  E'# Termos Gerais de Uso e Condições da Plataforma Waesy\n\n**Última atualização:** Agosto de 2026 | **Versão:** 2.0\n\nBem-vindo à **Waesy**, uma plataforma de ecossistema integrado que reúne comércio local, serviços, classificados, cultura e mobilidade urbana.\n\nAo acessar ou utilizar a plataforma Waesy, você concorda integralmente com estes Termos de Serviço e com todas as diretrizes complementares aqui referenciadas.\n\n---\n\n### 1. Objeto e Natureza da Plataforma\n1.1. A Waesy opera como plataforma tecnológica de intermediação digital, permitindo que consumidores, produtores, comerciantes independentes, prestadores de serviços e motoristas parceiros se conectem de forma ágil e segura.\n1.2. O cadastro e utilização de recursos transacionais da plataforma implicam a aceitação expressa e inequívoca destas regras.\n\n### 2. Cadastro, Conta e Responsabilidade do Usuário\n2.1. Para usufruir de recursos completos (compras, agendamentos, anúncios de classificados e gestão de lojas), o usuário deve criar uma conta fornecendo dados verídicos e atualizados.\n2.2. A conta é pessoal e intransferível. O usuário é o único responsável pela guarda e sigilo de suas credenciais de acesso.\n2.3. A Waesy reserva-se o direito de suspender ou encerrar contas que violem normas legais, pratiquem fraudes ou desrespeitem as políticas comunitárias.\n\n### 3. Compras, Pagamentos e Liquidação Financeira\n3.1. As transações realizadas através do checkout integrado são processadas por instituições de pagamento parceiras devidamente autorizadas pelo Banco Central do Brasil.\n3.2. Os preços exibidos na vitrine pública são informados e mantidos pelos respectivos lojistas e vendedores parceiros.\n\n### 4. Propriedade Intelectual\n4.1. Toda a identidade visual, código-fonte, arquitetura, design system, logomarcas e conteúdos originais da Waesy são de propriedade exclusiva da plataforma e protegidos pela legislação de propriedade industrial e direitos autorais.\n\n### 5. Foro e Legislação Aplicável\n5.1. Estes Termos são regidos pelas leis da República Federativa do Brasil, em especial o Marco Civil da Internet (Lei nº 12.965/2014) e o Código de Defesa do Consumidor (Lei nº 8.078/1990).'
),
(
  'privacidade',
...
(
  ...
  E'# Termo de Isenção da Plataforma e Diretrizes de Negociações P2P\n\n**Última atualização:** Agosto de 2026 | **Versão:** 2.0\n\nEste documento estabelece as diretrizes e limites de responsabilidade referentes à utilização das áreas de **Classificados, Desapego, Mural Comunitário, Empregos e Negociações Diretas (P2P)** na plataforma Waesy.\n\n---\n\n### 1. Intermediação e Papel da Plataforma\n1.1. A Waesy atua como facilitadora tecnológica e vitrine digital para que usuários particulares, autônomos e anunciantes publiquem itens, veículos, imóveis, serviços e vagas.\n1.2. Nas negociações diretas entre particulares que não utilizam o checkout integrado da Waesy, a plataforma **não é parte integrante do contrato de compra e venda** e não detém a posse física dos bens anunciados.\n\n### 2. Isenção Expressa de Responsabilidade\n2.1. A Waesy não se responsabiliza por:\n  - Vícios ocultos, defeitos, autenticidade ou qualidade dos produtos negociados diretamente fora do fluxo com garantia da plataforma;\n  - Prazos de entrega ou acordos verbais firmados exclusivamente entre compradores e vendedores autônomos;\n  - Pagamentos realizados fora dos meios seguros disponibilizados pela Waesy (ex: depósitos antecipados não rastreados).\n\n### 3. Recomendações de Segurança para Negociações\n- **Nunca realize pagamentos antecipados** a vendedores não verificados sem antes inspecionar o produto presencialmente;\n- Marque encontros para entrega em locais públicos e movimentados;\n- Denuncie imediatamente qualquer anúncio com indício de fraude ou conteúdo proibido através do botão **Denunciar Anúncio**.'
),
(
  'lojistas',
