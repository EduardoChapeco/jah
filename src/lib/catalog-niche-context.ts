...
export function getNicheCatalogContext(storeSegmentRaw?: string | null): NicheCatalogContext {
  ...
  if (segment.includes("imove") || segment.includes("imobili") || segment.includes("corret")) {
    return {
      ...
      addDimensionDesc: "Ex: Andar (Baixo, Alto), Posição Solar (Norte, Leste) ou Vagas.",
  ...
  if (
    ...
    return {
      ...
      addDimensionDesc: "Ex: Tipo de Corte (Em Bifes, Peça Inteira, Moído) ou Embalagem (500g, 1kg).",
