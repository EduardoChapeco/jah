...
import { Storefront, ForkKnife, Scissors, Briefcase, AirplaneTilt, Compass, Heartbeat, Coffee, TShirt, Key, CarProfile, CalendarDots, ArrowRight, Flame,  } from "@phosphor-icons/react";
