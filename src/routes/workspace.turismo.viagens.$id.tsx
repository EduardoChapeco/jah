...
function WorkspaceTripDetailPage() {
 ...
 {/* ── SHEET DE ADICIONAR LOCALIZADOR ── */}
 <Sheet open={isAddLocatorOpen} onOpenChange={setIsAddLocatorOpen}>
 <SheetContent side="right" className="sm:max-w-md p-6 overflow-y-auto flex flex-col justify-between">
 <div>
 <SheetHeader>
 <SheetTitle className="text-base font-bold">Adicionar Localizador / PNR</SheetTitle>
