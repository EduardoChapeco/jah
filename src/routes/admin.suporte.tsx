...
function SupportInboxPage() {
  ...
  return (
    <div className="space-y-6 h-[80vh] flex flex-col">
      ...
      <div className="flex-1 bg-card border overflow-hidden flex">
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-4">
                {thread?.messages.map((m: any) => (
                  <div key={m.id} className={`flex ${m.isMe ? "justify-end" : "justify-start"}`}>
                    <div
                      className={`max-w-[70%] p-3 ${m.isInternal ? "bg-warning text-warning border border-yellow-200" : m.isMe ? "bg-primary text-primary-foreground" : "bg-muted text-foreground"}`}
                    >
                      <div className="flex items-center gap-2 mb-1 opacity-70">
                        ...
                        {m.isInternal && (
                          <span className="text-[10px] uppercase font-bold">(Nota Interna)</span>
                        )}
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      className={isInternal ? "bg-warning border-yellow-200" : ""}
                    />
