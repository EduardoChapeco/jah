...
export const Route = createFileRoute("/workspace/turismo/viagens/")({
 head: () => ({ meta: [{ title: "Viagens & Reservas Confirmadas | Workspace Wider OS" }] }),
 loader: async () => {
...
function WorkspaceTripsListPage() {
 ...
 <div className="h-11 p-1 rounded-xl bg-muted/30 border border-border/70 flex items-center gap-1 overflow-x-auto no-scrollbar shrink-0">
