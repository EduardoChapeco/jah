    ...
    <div className="flex flex-col gap-6 p-6 max-w-7xl mx-auto w-full">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-foreground flex items-center gap-2">
            ...
            Malha Aérea & Reconciliação de Voos (PNR)
          </h1>
          <p className="text-sm text-muted-foreground mt-1">
            Gestão de bilhetes, localizadores GDS, trechos aéreos, franquias de bagagem e emissões.
          </p>
        </div>

        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogTrigger asChild>
            <Button className="h-11 px-5 gap-2 text-sm font-semibold rounded-xl shadow-sm">
              <Plus className="size-4" />
              Novo Itinerário & Trecho
            </Button>
          </DialogTrigger>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
        <div className="p-4 rounded-2xl border border-border bg-card shadow-sm flex items-center gap-4">
          ...
          <div>
            <p className="text-xs font-medium text-muted-foreground uppercase">Total Itinerários</p>
        ...
        <div className="p-4 rounded-2xl border border-border bg-card shadow-sm flex items-center gap-4">
          ...
          <div>
            <p className="text-xs font-medium text-muted-foreground uppercase">Trechos Ativos</p>
            <p className="text-2xl font-bold text-foreground">
              {itineraries.reduce((acc, it) => acc + (it.segments?.length || 0), 0)}
            </p>
          </div>
        </div>
        ...
        <div className="p-4 rounded-2xl border border-border bg-card shadow-sm flex items-center gap-4">
          ...
          <div>
            <p className="text-xs font-medium text-muted-foreground uppercase">Localizadores PNR</p>
            <p className="text-2xl font-bold text-foreground">
              {itineraries.filter((it) => it.segments?.some((s) => s.record_locator)).length}
            </p>
          </div>
        </div>
        ...
        <div className="p-4 rounded-2xl border border-border bg-card shadow-sm flex items-center gap-4">
          ...
          <div>
            <p className="text-xs font-medium text-muted-foreground uppercase">Status GDS</p>
            <p className="text-2xl font-bold text-foreground">100% Sincronizado</p>
          </div>
        </div>
      </div>
      ...
      <div className="relative">
        ...
        <Input
          placeholder="Filtrar por título, trecho (GRU, MIA), voo ou localizador PNR..."
          value={searchTerm}
