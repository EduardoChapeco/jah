      ...
      try {
        ...
        if (rows && rows.length > 0) {
          ...
          setData({
            ...
            parties_masked: 'C***** D******* / JAH Turismo Ltda',
            ...
            issuer: 'JAH Turismo Autenticações Digitais',
            status: 'signed',
          });
        }
      } catch (err: any) {
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-zinc-950 flex flex-col items-center justify-center p-4">
      <div className="max-w-md w-full bg-white dark:bg-zinc-900 rounded-2xl shadow-xl border border-border p-6 sm:p-8 flex flex-col gap-6">
        ...
        <div className="pt-2 text-center text-[11px] text-muted-foreground border-t border-border/50">
          Esta certidão comprova a inviolabilidade do documento assinado eletronicamente sob guarda do sistema JAH Master OS.
        </div>
      </div>
    </div>
  );
