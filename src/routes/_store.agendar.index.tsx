...
export const Route = createFileRoute("/_store/agendar/")({
 head: () => ({
 meta: [
 { title: "Agendamentos & Serviços | Wider OS" },
 {
 name: "description",
 content:
...
const BOOKING_CATEGORIES = [
 ...
 { id: "beleza", label: "Salão & Cabelo", icon: Tag },
 { id: "manicure", label: "Unhas & Manicure", icon: Tag },
 { id: "estetica", label: "Estética & Massagem", icon: Tag },
