...
function AdminEventsIndex() {
  ...
  const filteredEvents = events.filter((e: any) => e.title.toLowerCase().includes(search.toLowerCase()));
    ...
    <div className="flex flex-col gap-6 max-w-7xl mx-auto w-full p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        {filteredEvents.length === 0 && (
          <div className="col-span-full py-12 text-center text-muted-foreground bg-muted/20 border border-dashed">
            {events.length === 0
