...
import {
  ...
  Play, ArrowLeft, ArrowRight, Maximize, Minimize, StickyNote, Sparkles,
        ...
        <div className="w-64 border-r flex flex-col bg-muted/10 shrink-0">
          <Tabs value={leftTab} onValueChange={setLeftTab} className="flex flex-col h-full">
            <TabsList className="w-full rounded-none border-b grid grid-cols-4">
              ...
              <TabsTrigger value="ai" className="text-[10px] px-1"><Sparkles className="h-3 w-3" /></TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="ai" className="flex-1 overflow-hidden m-0">
              <div className="p-3 space-y-3">
                ...
                >
                  {editor.generating ? <Loader2 className="h-4 w-4 mr-1 animate-spin" /> : <Sparkles className="h-4 w-4 mr-1" />}
                  Gerar Slides
                </Button>
              </div>
            </TabsContent>
