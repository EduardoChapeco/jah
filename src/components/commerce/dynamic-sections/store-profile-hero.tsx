          ...
          >
            {store.logo_url ? (
              <img
                src={store.logo_url}
                alt={store.name}
                className="size-24 object-contain p-1   bg-card/80 backdrop-blur-xs"
              />
            ) : (
              <div className="size-24 rounded-full bg-background border border-background  flex items-center justify-center text-primary">
