  ...
  return (
    <section className="py-6 bg-background w-full relative">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 space-y-6 pb-24">
        ...
        <div className="sticky top-0 z-10 bg-background/95 backdrop-blur-md py-2 -mx-4 px-4 sm:-mx-6 sm:px-6 border-b border-border/40 flex items-center gap-1.5 overflow-x-auto no-scrollbar scrollbar-none">
