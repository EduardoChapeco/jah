    ...
    >
        ...
        >
          {vm.agency.logo_url ? (
            <img
              ...
              className="h-12 w-auto object-contain mb-auto"
            />
          ) : (
          ...
          <div>
            ...
            <p className="text-sm opacity-80 max-w-sm">
              Um roteiro desenhado sob medida para você aproveitar o melhor de{" "}
              {p.destination || "seu destino"}.
            </p>
          </div>
        </div>
      ...
      */}
        ...
        <div className="grid grid-cols-2 gap-4 mb-16 break-inside-avoid">
          <div className="bg-slate-50 border border-slate-100 p-6 rounded-2xl">
            ...
            <div className="text-lg font-bold text-slate-900">
              {vm.client.name || "Cliente a confirmar"}
            </div>
            {vm.client.email && (
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <span className="ds-label-caps" style={{ color: brand }}>
                          {f.airline || "Companhia"}
                        </span>
                      </div>
                    ...
                    <div className="p-6 flex items-center">
                      <div className="w-[30%] text-center">
                        <div className="text-4xl font-bold font-sans tracking-tighter text-slate-900">
                        ...
                        {f.date && (
                          <div className="text-xs text-slate-500 mt-1">{formatDate(f.date)}</div>
                        )}
                      </div>
                ...
                <div className="border-l-2 py-2" style={{ borderColor: `${brand}40` }}>
                  {p.itinerary!.map((d, i) => (
                    <div key={i} className="relative pl-8 pb-10 last:pb-0 break-inside-avoid">
                      <div
                        className="absolute w-5 h-5 rounded-full -left-[11px] border-[3px] border-white top-1 flex items-center justify-center text-[9px] font-bold text-white"
      ...
      <div className="mt-auto border-t border-slate-200 bg-white px-12 py-8 flex justify-between items-center break-inside-avoid">
        {p.agent_name ? (
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="ds-label-caps text-slate-400 mb-1">Consultor Oficial</div>
              {p.agent_whatsapp && (
        ...
        <div className="text-right">
          <div className="ds-meta uppercase tracking-widest text-slate-400 mb-1">Documento Ref</div>
