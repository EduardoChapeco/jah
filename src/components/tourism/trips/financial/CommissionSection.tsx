      ...
      >
        ...
        <div className="flex items-center gap-3">
          <span className="text-xs font-mono text-success font-bold">
            Agência: {formatCurrency(agencyCommission, currency)}
          </span>
          {open ? (
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-4 border-t border-border/55">
            <div className="rounded-2xl border border-border bg-surface-alt/40 p-3">
              ...
              <div className="text-lg font-bold text-foreground font-mono">
                {formatCurrency(baseComissionavel, currency)}
              </div>
              <div className="ds-meta text-muted-foreground mt-0.5">
                Venda total (itens): R${" "}
                {items
            ...
            <div className="rounded-2xl border border-success/20 bg-success/5 p-3">
              <div className="ds-label-caps tracking-wider text-success mb-1">Comissão Agência</div>
              <div className="text-lg font-bold text-success font-mono">
                {formatCurrency(agencyCommission, currency)}
              </div>
              <div className="ds-meta text-muted-foreground mt-0.5">
                Inclui bônus de R${" "}
