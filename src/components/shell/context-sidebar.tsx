import { Tag, Newspaper, Gift, Target } from "lucide-react";
...
// ── 1. Módulos Principais do MVP (Ordem Estrita do Conselho) ──
const MAIN_EXPLORER_ITEMS = [
  ...
  { to: "/ofertas", label: "Ofertas", icon: Flame, exact: true },
  { to: "/mercado", label: "Mercado", icon: ShoppingBag, exact: true },
  { to: "/diretorio", label: "Guia", icon: Compass, exact: true },
  { to: "/convite", label: "Convide & Ganhe", icon: Gift, exact: true, isLucide: true, isInvite: true },
