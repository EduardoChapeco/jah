...
## plataforma Waesy / Waesy Community OS — Engenharia de Confiabilidade & Padrão Apple HIG
...
```bash
npm run build && npx wrangler pages deploy dist --project-name=waesy --branch=main
```
