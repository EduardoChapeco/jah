...
- **Ação**: Resgatar a lógica do `renderDynamicField` do antigo editor e portá-la para a aba "Conteúdo" do novo painel em [admin.builder.$documentId.editor.tsx](file:///c:/Users/Excelência Tour SMO/Documents/waesy/src/routes/admin.builder.$documentId.editor.tsx).
