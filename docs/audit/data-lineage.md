...
Este documento constrói o rastreamento completo da cadeia de dados da plataforma Waesy Commerce, desde o campo da UI até a persistência no banco e propagação para os consumidores dependentes.
