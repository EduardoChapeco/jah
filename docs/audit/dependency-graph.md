...
Este documento mapeia o acoplamento entre os serviços do BFF, as rotas do TanStack Router, os eventos do banco PostgreSQL e a invalidação de cache na plataforma Waesy Commerce.
