...
- A Waesy deve renderizar exatamente a mesma árvore de `experience_nodes` do Storefront ou Vitrine, mas envelopada num `AppShell` nativo com roteamento do TanStack Router interceptado.
