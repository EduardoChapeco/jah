# Mapa de Capacidades (Gap Analysis): Waesy Builder Legacy vs Motor Canônico
...
A reengenharia necessita mover a Waesy do estado estático "Array 1D" para o modelo de Editor Baseado em Árvore DOM (Hierarchy Tree Engine), que suporta nativamente o TanStack Router Server Side Rendering.
